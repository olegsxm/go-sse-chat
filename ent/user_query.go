...
func (uq *UserQuery) loadConversations(ctx context.Context, query *ConversationQuery, nodes []*User, init func(*User), assign func(*User, *Conversation)) error {
	...
	query.Where(func(s *sql.Selector) {
		...
		s.Join(joinT).On(s.C(conversation.FieldID), joinT.C(user.ConversationsPrimaryKey[0]))
		s.Where(sql.InValues(joinT.C(user.ConversationsPrimaryKey[1]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(user.ConversationsPrimaryKey[1]))
